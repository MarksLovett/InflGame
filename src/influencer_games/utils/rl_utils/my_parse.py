...
def add_rl_example_script_args(
    ...
    parser.add_argument(
            "--intial_postion",
            type=np.ndarray,
            default=player_postion_setup(num_agents=3,setup_type='intial_symmetric_setup',domain_type=args_start.domain_type,domain_bounds=args_start.domain_bounds),
    ...
    parser.add_argument(
        "--parameters",
        type=np.ndarray,
        default=player_parameter_setup(3,infl_type=args_start.infl_configs["infl_type"],setup_type="intial_symmetric_setup",reach=args_start.infl_parameter),
